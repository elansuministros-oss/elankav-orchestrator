...
test('DESIGN-DELIVERY-CLOSE-01 resuelve un asset visual con URL firmada de Supabase', async () => {
  const calls = [];
...
test('DESIGN-DELIVERY-CLOSE-01 rechaza assets no visuales para entrega', () => {
  assert.throws(
    () => assertResolvableImageAsset({
      bucket: 'design-request-assets',
