...
function headers(token, extra = {}) {
  return { Accept:'application/json', Authorization:`Bearer ${token}`, 'Content-Type':'application/json', 'X-Elankav-Platform':'ELAN_IA', 'X-Elankav-Actor-Type':'owner', 'X-Elankav-Role':'owner', 'X-Elankav-User-Id':'owner-whatsapp', 'X-Elankav-Source':'OWNER_WHATSAPP', ...extra };
}
...
module.exports = {
  OwnerBusinessConnectError, applyPayment, createCustomer, createDesignRequest, createLogisticsRule, createOwnerCustomer, createOwnerFamily, createOwnerProvider, createOwnerSeller, createPriceAuthorization, createQuotation, createWorkOrder,
  ...
  normalizeQuotationSource, removeQuotationImage, requestConnect, resolveCatalogPricing, reviseDesignRequest, revokePriceAuthorization, searchCustomers, searchOwnerContacts, searchProviders, sendOwnerWhatsApp, sendQuotationWhatsApp, setOwnerSellerPlatforms, updateOwnerCustomer, updateOwnerFamily, updateOwnerProvider, updateOwnerSeller, updateQuotation, uploadQuotationImage
};
